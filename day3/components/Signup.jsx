...
export default function Signuppage() {
 ...
 <div className="login-form">
  ...
  <form>
    <div class="user-box1">
    <input type="text" placeholder="FistName" id="username"  onChange={e=>setUser(e.target.value)} required />
      {/* <label>Username</label> */}
      <input autoComplete="off" type="LastName" placeholder="Password" id="password"  onChange={e=>setPassword(e.target.value)} required />
      {/* <label>Password</label> */}
      <input type="text" placeholder="Email" id="email" onChange={e=>setemail(e.target.value)}  required />
      <input type="text" placeholder='Password' name="dob"id='dateofbirth' onChange={e=>setdateofbirth(e.target.value)} required />
      <input type="text" placeholder='Confirm Password' name="yos" id='yrofstyding' onChange={e=>setyrofstyding(e.target.value)} required />
