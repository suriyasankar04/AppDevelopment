...
export default function Signuppage() {
  ...
  const handleSubmit = async (e) => {
    ...
    await register({username,dateofbirth,email,password})
 ...
 <div className="login-form">
  ...
  <form onSubmit={handleSubmit}>
    ...
    <input type="text" placeholder="FirstName" id="username"  onChange={e=>setUser(e.target.value)} required />
      ...
      <input autoComplete="off" type="text" placeholder="LastName" id="password"  onChange={e=>setdateofbirth(e.target.value)} required />
      {/* <label>Password</label> */}
      <input type="text" placeholder="Email" id="email" onChange={e=>setemail(e.target.value)}  required />
      <input type="password" placeholder='Password' name="dob"id='dateofbirth' onChange={e=>setPassword(e.target.value)} required />
